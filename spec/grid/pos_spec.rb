...
module Rubaship
  describe Pos do
    ...
    describe "::POS_REGEXP" do
      it "should match \"A3:Horiz\"" do
        "A3:Horiz".should match(Pos::POS_REGEXP)
      end

      it "should match \"B10:V\"" do
        "B10:V".should match(Pos::POS_REGEXP)
      end

      it "should match \"J1:ho\"" do
        "1J:ho".should match(Pos::POS_REGEXP)
      end

      it "should match \"J10:veRt\"" do
        "J10:veRt".should match(Pos::POS_REGEXP)
      end

      it "should not match \"F11:H\"" do
        "F11:H".should_not match(Pos::POS_REGEXP)
      end
    end
